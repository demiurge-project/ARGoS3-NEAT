...
#ifndef ICRA_STOP_LOOP_FUNC
#define ICRA_STOP_LOOP_FUNC
...
class IcraStopLoopFunction: public AutoMoDeLoopFunctions {
  public:
    IcraStopLoopFunction();
    IcraStopLoopFunction(const IcraStopLoopFunction& orig);
    virtual ~IcraStopLoopFunction();
