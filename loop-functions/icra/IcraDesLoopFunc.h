...
#ifndef ICRA_DES_LOOP_FUNC
#define ICRA_DES_LOOP_FUNC
...
class IcraDesLoopFunction: public AutoMoDeLoopFunctions {
  public:
    IcraDesLoopFunction();
    IcraDesLoopFunction(const IcraDesLoopFunction& orig);
    virtual ~IcraDesLoopFunction();
