...
#ifndef ICRA_AGG_LOOP_FUNC
#define ICRA_AGG_LOOP_FUNC
...
class IcraAggLoopFunction: public AutoMoDeLoopFunctions {
  public:
    IcraAggLoopFunction();
    IcraAggLoopFunction(const IcraAggLoopFunction& orig);
    virtual ~IcraAggLoopFunction();
