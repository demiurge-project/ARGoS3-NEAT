...
#ifndef ICRA_AGG_INA_LOOP_FUNC
#define ICRA_AGG_INA_LOOP_FUNC
...
class IcraAggInaLoopFunction: public AutoMoDeLoopFunctions {
  public:
    IcraAggInaLoopFunction();
    IcraAggInaLoopFunction(const IcraAggInaLoopFunction& orig);
    virtual ~IcraAggInaLoopFunction();
