...
#ifndef ICRA_DES_INA_LOOP_FUNC
#define ICRA_DES_INA_LOOP_FUNC
...
class IcraDesInaLoopFunction: public AutoMoDeLoopFunctions {
  public:
    IcraDesInaLoopFunction();
    IcraDesInaLoopFunction(const IcraDesInaLoopFunction& orig);
    virtual ~IcraDesInaLoopFunction();
