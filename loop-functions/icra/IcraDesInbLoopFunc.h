...
#ifndef ICRA_DES_INB_LOOP_FUNC
#define ICRA_DES_INB_LOOP_FUNC
...
class IcraDesInbLoopFunction: public AutoMoDeLoopFunctions {
  public:
    IcraDesInbLoopFunction();
    IcraDesInbLoopFunction(const IcraDesInbLoopFunction& orig);
    virtual ~IcraDesInbLoopFunction();
