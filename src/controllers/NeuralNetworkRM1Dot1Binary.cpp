#include "NeuralNetworkRM1Dot1Binary.h"
   ...
   if(m_pcRAB != NULL) {
	...
	cAttractionVector *= (2/(1+exp(-len)) - 1);
      ...
      for(int i = 20; i < 24; i++) {
         ...
         Real value = cAttractionVector.DotProduct(CVector2(1.0, cDirection));
...
void NeuralNetworkRM1Dot1Binary::Reset() {
...
void NeuralNetworkRM1Dot1Binary::Destroy() {}

REGISTER_CONTROLLER(NeuralNetworkRM1Dot1Binary, "nn_rm_1dot1_bin_controller")
